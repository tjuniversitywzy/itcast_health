...
public class SMSUtils {
	public static final String VALIDATE_CODE = "SMS_182674334";//发送短信验证码
	...
	public static void sendShortMessage(String phoneNumbers,String param) throws ClientException{
		...
		final String accessKeyId = "LTAI4FpFUsD4AYbzRkcxDtTT";// 你的accessKeyId,
		final String accessKeySecret = "Lgpxm2BQ3Y0YgJlZEZdzY9KNOIOGzG";// 你的accessKeySecret，
	...
	public static void main(String args[]) throws Exception{
		...
		SMSUtils.sendShortMessage("18602284369",validateCode);
	}
}
